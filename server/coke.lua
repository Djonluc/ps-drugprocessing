...
RegisterServerEvent('ps-drugprocessing:processCocaLeaf', function()
    ...
    -- Check if the player has enough 'coca_leaf'
    local cocaLeaf = Player.Functions.GetItemByName('coca_leaf')

    if cocaLeaf and cocaLeaf.amount >= Config.CokeProcessing.CokeLeaf then
        if Player.Functions.RemoveItem('coca_leaf', Config.CokeProcessing.CokeLeaf) then
            if Player.Functions.AddItem('coke', Config.CokeProcessing.ProcessCokeLeaf) then
                TriggerClientEvent("inventory:client:ItemBox", src, QBCore.Shared.Items['coca_leaf'], "remove", Config.CokeProcessing.CokeLeaf)
                TriggerClientEvent("inventory:client:ItemBox", src, QBCore.Shared.Items['coke'], "add", Config.CokeProcessing.ProcessCokeLeaf)
                ...
                TriggerClientEvent('QBCore:Notify', src, Lang:t("error.no_space"), "error") -- Added notification for no space in inventory
            end
        end
    else
        TriggerClientEvent('QBCore:Notify', src, Lang:t("error.no_coca_leaf"), "error")
...
RegisterServerEvent('ps-drugprocessing:processCocaPowder', function()
    ...
    -- Check if the player has enough 'coke' and 'bakingsoda'
    local coke = Player.Functions.GetItemByName('coke')
    local bakingSoda = Player.Functions.GetItemByName('bakingsoda')

    if coke and coke.amount >= Config.CokeProcessing.Coke then
        if bakingSoda and bakingSoda.amount >= Config.CokeProcessing.BakingSoda then
            if Player.Functions.RemoveItem('coke', Config.CokeProcessing.Coke) then
                if Player.Functions.RemoveItem('bakingsoda', Config.CokeProcessing.BakingSoda) then
                    if Player.Functions.AddItem('coke_small_brick', Config.CokeProcessing.SmallCokeBrick) then
                        TriggerClientEvent("inventory:client:ItemBox", src, QBCore.Shared.Items['coke'], "remove", Config.CokeProcessing.Coke)
                        TriggerClientEvent("inventory:client:ItemBox", src, QBCore.Shared.Items['bakingsoda'], "remove", Config.CokeProcessing.BakingSoda)
                        TriggerClientEvent("inventory:client:ItemBox", src, QBCore.Shared.Items['coke_small_brick'], "add", Config.CokeProcessing.SmallCokeBrick)
        ...
        TriggerClientEvent('QBCore:Notify', src, Lang:t("error.no_coke"), "error") -- Fixed typo and added missing notification
    end
end)
...
RegisterServerEvent('ps-drugprocessing:processCocaBrick', function()
    ...
    -- Check if the player has enough 'coke_small_brick'
    local smallCokeBrick = Player.Functions.GetItemByName('coke_small_brick')

    if smallCokeBrick and smallCokeBrick.amount >= Config.CokeProcessing.SmallBrick then
        ...
        TriggerClientEvent('QBCore:Notify', src, Lang:t("error.no_coke_small_brick"), "error")
    end
end)
